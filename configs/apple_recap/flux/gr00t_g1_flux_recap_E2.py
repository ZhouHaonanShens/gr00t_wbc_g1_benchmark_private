...
CONFIG = build_variant_config(
    variant_id="gr00t_g1_flux_recap_E2",
    train_relative_path=(
        "agent/artifacts/apple_recap_flux_graft/models/gr00t_g1_flux_recap_E2/train_model_ref.json"
    ),
    inference_relative_path=(
        "agent/artifacts/apple_recap_flux_graft/models/gr00t_g1_flux_recap_E2/inference_model_ref.json"
    ),
)
